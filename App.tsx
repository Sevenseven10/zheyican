...
function AddMeal({ meal, onCancel, onSave, onDelete }: { meal: Meal | null; onCancel: () => void; onSave: () => void; onDelete: () => Promise<void> }) {
  ...
  return <View style={styles.addApp}><StatusBar style="light" /><ScrollView contentContainerStyle={[styles.addPage, platformLayout.addPage, styles.editorPage]} keyboardShouldPersistTaps="handled">
